...
class GestionFinancieraApp:
    ...
    def function_home_page(self):
        self.frame_home = Frame(self.main_frame, width=500, height=400)
        titulo_home = Label(self.frame_home, text="Bienvenido a la gestion de Financiera", font=("Bold", 15)).place(x=150, y=30)
        self.frame_home.grid(pady=5, padx=5)
        self.frame_home.pack_propagate(False)

    def function_frame_presupuesto(self):
        self.frame_presupuesto = Frame(self.main_frame, width=500, height=400)
        titulo_presupuesto = Label(self.frame_presupuesto, text="Presupuesto", font=("Bold", 15)).place(x=150, y=30)
    ...
    def function_frame_gananciasBrutas(self):
        ...
        titulo_gananciasBrutas = Label(self.frame_gananciasBrutas, text="Ganancias Brutas", font=("Bold", 15)).place(x=150, y=30)
    ...
    def function_frame_gananciasNetas(self):
        ...
        titulo_gananciasNetas = Label(self.frame_gananciasNetas, text="Ganancias Netas", font=("Bold", 15)).place(x=150, y=30)
    ...
    def function_frame_gastosMateriales(self):
        ...
        titulo_gastosMateriales = Label(self.frame_gastosMateriales, text="Gastos Inventario", font=("Bold", 15)).place(x=150, y=30)
    ...
    def function_frame_pagosEmpleados(self):
        ...
        titulo_pagosEmpleados = Label(self.frame_pagosEmpleados, text="Pagos Empleados", font=("Bold", 15)).place(x=150, y=30)
